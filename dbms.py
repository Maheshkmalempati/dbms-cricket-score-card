...
def add_player():
    ...
    Button(pwindow, text="DELETE", font=('Times New Roman', 15), command=deletepla).place(x=900, y=600)
    pwindow.mainloop()

#delete player function
def deletepla():
    delpla = deleteplayer.get()
    if delpla != '':
        dbc.deleteplayer((delpla))
        mb.showinfo('Done!', "player deleted", parent=root2)
        root2.destroy()
    else:
        mb.showerror('Warning', "All Fields are necessary", parent=root2)
